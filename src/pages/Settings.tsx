    ...
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-2">
          {[
            { name: '基本资料', icon: User, active: true },
            { name: 'API 管理', icon: Key, active: false },
            { name: '安全中心', icon: Shield, active: false },
            { name: '通知提醒', icon: Bell, active: false },
            { name: '数据存储', icon: Database, active: false },
          ].map((item) => (
            <button
              key={item.name}
